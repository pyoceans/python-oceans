/* Generated by Cython 0.12.1 on Wed Oct 27 14:59:09 2010 */
...
/* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":5
 * cimport numpy as np
 * 
...
static  void __pyx_f_12lic_internal__advance(float __pyx_v_vx, float __pyx_v_vy, int *__pyx_v_x, int *__pyx_v_y, float *__pyx_v_fx, float *__pyx_v_fy, int __pyx_v_w, int __pyx_v_h) {
  ...
  int __pyx_t_1;
  float __pyx_t_2;
  __Pyx_RefNannySetupContext("_advance");

  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":8
 *         int* x, int* y, float*fx, float*fy, int w, int h):
 *     cdef float tx, ty
 *     if vx>=0:             # <<<<<<<<<<<<<<
 *         tx = (1-fx[0])/vx
 *     else:
 */
  __pyx_t_1 = (__pyx_v_vx >= 0);
  if (__pyx_t_1) {

    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":9
 *     cdef float tx, ty
 *     if vx>=0:
 *         tx = (1-fx[0])/vx             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":11
 *         tx = (1-fx[0])/vx
 *     else:
 *         tx = -fx[0]/vx             # <<<<<<<<<<<<<<
 *     if vy>=0:
 ...
 */
  ...
  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":12
 *     else:
 *         tx = -fx[0]/vx
 *     if vy>=0:             # <<<<<<<<<<<<<<
 *         ty = (1-fy[0])/vy
 *     else:
 */
  __pyx_t_1 = (__pyx_v_vy >= 0);
  if (__pyx_t_1) {

    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":13
 *         tx = -fx[0]/vx
 *     if vy>=0:
 *         ty = (1-fy[0])/vy             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":15
 *         ty = (1-fy[0])/vy
 *     else:
 *         ty = -fy[0]/vy             # <<<<<<<<<<<<<<
 *     if tx<ty:
 ...
 */
  ...
  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":16
 *     else:
 *         ty = -fy[0]/vy
 *     if tx<ty:             # <<<<<<<<<<<<<<
 *         if vx>=0:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":17
 *         ty = -fy[0]/vy
 *     if tx<ty:
 *         if vx>=0:             # <<<<<<<<<<<<<<
 *             x[0]+=1
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":18
 *     if tx<ty:
 *         if vx>=0:
 *             x[0]+=1             # <<<<<<<<<<<<<<
 *             fx[0]=0
 ...
 */
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":19
 *         if vx>=0:
 *             x[0]+=1
 *             fx[0]=0             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":21
 *             fx[0]=0
 *         else:
 *             x[0]-=1             # <<<<<<<<<<<<<<
 *             fx[0]=1
 ...
 */
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":22
 *         else:
 *             x[0]-=1
 *             fx[0]=1             # <<<<<<<<<<<<<<
 *         fy[0]+=tx*vy
 ...
 */
    ...
    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":23
 *             x[0]-=1
 *             fx[0]=1
 *         fy[0]+=tx*vy             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":25
 *         fy[0]+=tx*vy
 *     else:
 *         if vy>=0:             # <<<<<<<<<<<<<<
 *             y[0]+=1
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":26
 *     else:
 *         if vy>=0:
 *             y[0]+=1             # <<<<<<<<<<<<<<
 *             fy[0]=0
 ...
 */
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":27
 *         if vy>=0:
 *             y[0]+=1
 *             fy[0]=0             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":29
 *             fy[0]=0
 *         else:
 *             y[0]-=1             # <<<<<<<<<<<<<<
 *             fy[0]=1
 ...
 */
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":30
 *         else:
 *             y[0]-=1
 *             fy[0]=1             # <<<<<<<<<<<<<<
 *         fx[0]+=ty*vx
 ...
 */
    ...
    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":31
 *             y[0]-=1
 *             fy[0]=1
 *         fx[0]+=ty*vx             # <<<<<<<<<<<<<<
 *     if x[0]>=w:
 ...
 */
  ...
  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":32
 *             fy[0]=1
 *         fx[0]+=ty*vx
 *     if x[0]>=w:             # <<<<<<<<<<<<<<
 *         x[0]=w-1 # FIXME: other boundary conditions?
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":33
 *         fx[0]+=ty*vx
 *     if x[0]>=w:
 *         x[0]=w-1 # FIXME: other boundary conditions?             # <<<<<<<<<<<<<<
 *     if x[0]<0:
 ...
 */
  ...
  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":34
 *     if x[0]>=w:
 *         x[0]=w-1 # FIXME: other boundary conditions?
 *     if x[0]<0:             # <<<<<<<<<<<<<<
 *         x[0]=0 # FIXME: other boundary conditions?
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":35
 *         x[0]=w-1 # FIXME: other boundary conditions?
 *     if x[0]<0:
 *         x[0]=0 # FIXME: other boundary conditions?             # <<<<<<<<<<<<<<
 *     if y[0]<0:
 ...
 */
  ...
  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":36
 *     if x[0]<0:
 *         x[0]=0 # FIXME: other boundary conditions?
 *     if y[0]<0:             # <<<<<<<<<<<<<<
 *         y[0]=0 # FIXME: other boundary conditions?
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":37
 *         x[0]=0 # FIXME: other boundary conditions?
 *     if y[0]<0:
 *         y[0]=0 # FIXME: other boundary conditions?             # <<<<<<<<<<<<<<
 *     if y[0]>=h:
 ...
 */
  ...
  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":38
 *     if y[0]<0:
 *         y[0]=0 # FIXME: other boundary conditions?
 *     if y[0]>=h:             # <<<<<<<<<<<<<<
 *         y[0]=h-1 # FIXME: other boundary conditions?
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":39
 *         y[0]=0 # FIXME: other boundary conditions?
 *     if y[0]>=h:
 *         y[0]=h-1 # FIXME: other boundary conditions?             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("lic_internal._advance");
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":43
 * 
...
static PyObject *__pyx_pf_12lic_internal_line_integral_convolution(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_12lic_internal_line_integral_convolution(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  Py_ssize_t __pyx_bstride_2_vectors = 0;
  Py_ssize_t __pyx_bshape_0_vectors = 0;
  Py_ssize_t __pyx_bshape_1_vectors = 0;
  Py_ssize_t __pyx_bshape_2_vectors = 0;
  ...
  __Pyx_RefNannySetupContext("line_integral_convolution");
  ...
  if (unlikely(__pyx_kwds)) {
    ...
    if (unlikely(kw_args > 0)) {
      if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "line_integral_convolution") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    }
    ...
    __pyx_v_vectors = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 0));
    __pyx_v_texture = ((PyArrayObject *)PyTuple_GET_ITEM(__pyx_args, 1));
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("lic_internal.line_integral_convolution");
  return NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_kernel), __pyx_ptype_5numpy_ndarray, 1, "kernel", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 46; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_vectors, (PyObject*)__pyx_v_vectors, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_vectors = __pyx_bstruct_vectors.strides[0]; __pyx_bstride_1_vectors = __pyx_bstruct_vectors.strides[1]; __pyx_bstride_2_vectors = __pyx_bstruct_vectors.strides[2];
  __pyx_bshape_0_vectors = __pyx_bstruct_vectors.shape[0]; __pyx_bshape_1_vectors = __pyx_bstruct_vectors.shape[1]; __pyx_bshape_2_vectors = __pyx_bstruct_vectors.shape[2];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_texture, (PyObject*)__pyx_v_texture, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_kernel, (PyObject*)__pyx_v_kernel, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_kernel = __pyx_bstruct_kernel.strides[0];
  __pyx_bshape_0_kernel = __pyx_bstruct_kernel.shape[0];

  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":53
 ...
 */
  ...
  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":54
 * 
 *     h = vectors.shape[0]
 *     w = vectors.shape[1]             # <<<<<<<<<<<<<<
 *     t = vectors.shape[2]
 ...
 */
  ...
  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":55
 *     h = vectors.shape[0]
 *     w = vectors.shape[1]
 *     t = vectors.shape[2]             # <<<<<<<<<<<<<<
 *     kernellen = kernel.shape[0]
 ...
 */
  ...
  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":56
 *     w = vectors.shape[1]
 *     t = vectors.shape[2]
 *     kernellen = kernel.shape[0]             # <<<<<<<<<<<<<<
 *     if t!=2:
 ...
 */
  ...
  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":57
 *     t = vectors.shape[2]
 *     kernellen = kernel.shape[0]
 *     if t!=2:             # <<<<<<<<<<<<<<
 *         raise ValueError("Vectors must have two components (not %d)" % t)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":58
 *     kernellen = kernel.shape[0]
 *     if t!=2:
 *         raise ValueError("Vectors must have two components (not %d)" % t)             # <<<<<<<<<<<<<<
 *     result = np.zeros((h,w),dtype=np.float32)
 ...
 */
    ...
    __pyx_t_3 = 0;
    __pyx_t_3 = PyObject_Call(__pyx_builtin_ValueError, __pyx_t_2, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":59
 *     if t!=2:
 *         raise ValueError("Vectors must have two components (not %d)" % t)
 *     result = np.zeros((h,w),dtype=np.float32)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_6 = PyEval_CallObjectWithKeywords(__pyx_t_2, __pyx_t_4, ((PyObject *)__pyx_t_5)); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_7 = ((PyArrayObject *)__pyx_t_6);
  {
    ...
    __pyx_t_8 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_result, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack);
    if (unlikely(__pyx_t_8 < 0)) {
      PyErr_Fetch(&__pyx_t_9, &__pyx_t_10, &__pyx_t_11);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_result, (PyObject*)__pyx_v_result, &__Pyx_TypeInfo_float, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":61
 *     result = np.zeros((h,w),dtype=np.float32)
 * 
 *     for i in range(h):             # <<<<<<<<<<<<<<
 *         for j in range(w):
 ...
 */
  ...
  for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_8; __pyx_t_12+=1) {
    ...
    /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":62
 * 
 *     for i in range(h):
 *         for j in range(w):             # <<<<<<<<<<<<<<
 *             x = j
 ...
 */
    ...
    for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":63
 *     for i in range(h):
 *         for j in range(w):
 *             x = j             # <<<<<<<<<<<<<<
 *             y = i
 ...
 */
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":64
 *         for j in range(w):
 *             x = j
 *             y = i             # <<<<<<<<<<<<<<
 *             fx = 0.5
 ...
 */
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":65
 *             x = j
 *             y = i
 *             fx = 0.5             # <<<<<<<<<<<<<<
 *             fy = 0.5
 ...
 */
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":66
 *             y = i
 *             fx = 0.5
 *             fy = 0.5             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":68
 *             fy = 0.5
 * 
 *             k = kernellen//2             # <<<<<<<<<<<<<<
 *             #print i, j, k, x, y
 ...
 */
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":70
 *             k = kernellen//2
 *             #print i, j, k, x, y
 *             result[i,j] += kernel[k]*texture[x,y]             # <<<<<<<<<<<<<<
 *             while k<kernellen-1:
 ...
 */
      ...
      __pyx_t_16 = -1;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_bshape_0_kernel;
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_16 = 0;
      } else if (unlikely(__pyx_t_15 >= __pyx_bshape_0_kernel)) __pyx_t_16 = 0;
      ...
      __pyx_t_18 = -1;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_bshape_0_texture;
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_18 = 0;
      } else if (unlikely(__pyx_t_16 >= __pyx_bshape_0_texture)) __pyx_t_18 = 0;
      if (__pyx_t_17 < 0) {
        __pyx_t_17 += __pyx_bshape_1_texture;
        if (unlikely(__pyx_t_17 < 0)) __pyx_t_18 = 1;
      } else if (unlikely(__pyx_t_17 >= __pyx_bshape_1_texture)) __pyx_t_18 = 1;
      ...
      } else if (unlikely(__pyx_t_18 >= __pyx_bshape_0_result)) __pyx_t_20 = 0;
      if (__pyx_t_19 < 0) {
        __pyx_t_19 += __pyx_bshape_1_result;
        if (unlikely(__pyx_t_19 < 0)) __pyx_t_20 = 1;
      } else if (unlikely(__pyx_t_19 >= __pyx_bshape_1_result)) __pyx_t_20 = 1;
      if (unlikely(__pyx_t_20 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_20);
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      *__Pyx_BufPtrStrided2d(float *, __pyx_bstruct_result.buf, __pyx_t_18, __pyx_bstride_0_result, __pyx_t_19, __pyx_bstride_1_result) += ((*__Pyx_BufPtrStrided1d(float *, __pyx_bstruct_kernel.buf, __pyx_t_15, __pyx_bstride_0_kernel)) * (*__Pyx_BufPtrStrided2d(float *, __pyx_bstruct_texture.buf, __pyx_t_16, __pyx_bstride_0_texture, __pyx_t_17, __pyx_bstride_1_texture)));

      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":71
 *             #print i, j, k, x, y
 *             result[i,j] += kernel[k]*texture[x,y]
 *             while k<kernellen-1:             # <<<<<<<<<<<<<<
 *                 _advance(vectors[y,x,0],vectors[y,x,1],
 ...
 */
      while (1) {
        ...
        /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":72
 *             result[i,j] += kernel[k]*texture[x,y]
 *             while k<kernellen-1:
 *                 _advance(vectors[y,x,0],vectors[y,x,1],             # <<<<<<<<<<<<<<
 *                         &x, &y, &fx, &fy, w, h)
 ...
 */
        ...
        __pyx_t_23 = -1;
        if (__pyx_t_20 < 0) {
          __pyx_t_20 += __pyx_bshape_0_vectors;
          if (unlikely(__pyx_t_20 < 0)) __pyx_t_23 = 0;
        } else if (unlikely(__pyx_t_20 >= __pyx_bshape_0_vectors)) __pyx_t_23 = 0;
        if (__pyx_t_21 < 0) {
          __pyx_t_21 += __pyx_bshape_1_vectors;
          if (unlikely(__pyx_t_21 < 0)) __pyx_t_23 = 1;
        } else if (unlikely(__pyx_t_21 >= __pyx_bshape_1_vectors)) __pyx_t_23 = 1;
        if (__pyx_t_22 < 0) {
          __pyx_t_22 += __pyx_bshape_2_vectors;
          if (unlikely(__pyx_t_22 < 0)) __pyx_t_23 = 2;
        } else if (unlikely(__pyx_t_22 >= __pyx_bshape_2_vectors)) __pyx_t_23 = 2;
        ...
        __pyx_t_26 = -1;
        if (__pyx_t_23 < 0) {
          __pyx_t_23 += __pyx_bshape_0_vectors;
          if (unlikely(__pyx_t_23 < 0)) __pyx_t_26 = 0;
        } else if (unlikely(__pyx_t_23 >= __pyx_bshape_0_vectors)) __pyx_t_26 = 0;
        if (__pyx_t_24 < 0) {
          __pyx_t_24 += __pyx_bshape_1_vectors;
          if (unlikely(__pyx_t_24 < 0)) __pyx_t_26 = 1;
        } else if (unlikely(__pyx_t_24 >= __pyx_bshape_1_vectors)) __pyx_t_26 = 1;
        if (__pyx_t_25 < 0) {
          __pyx_t_25 += __pyx_bshape_2_vectors;
          if (unlikely(__pyx_t_25 < 0)) __pyx_t_26 = 2;
        } else if (unlikely(__pyx_t_25 >= __pyx_bshape_2_vectors)) __pyx_t_26 = 2;
        if (unlikely(__pyx_t_26 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_26);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }

        /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":73
 *             while k<kernellen-1:
 *                 _advance(vectors[y,x,0],vectors[y,x,1],
 *                         &x, &y, &fx, &fy, w, h)             # <<<<<<<<<<<<<<
 *                 k+=1
 *                 #print i, j, k, x, y
 */
        __pyx_f_12lic_internal__advance((*__Pyx_BufPtrStrided3d(float *, __pyx_bstruct_vectors.buf, __pyx_t_20, __pyx_bstride_0_vectors, __pyx_t_21, __pyx_bstride_1_vectors, __pyx_t_22, __pyx_bstride_2_vectors)), (*__Pyx_BufPtrStrided3d(float *, __pyx_bstruct_vectors.buf, __pyx_t_23, __pyx_bstride_0_vectors, __pyx_t_24, __pyx_bstride_1_vectors, __pyx_t_25, __pyx_bstride_2_vectors)), (&__pyx_v_x), (&__pyx_v_y), (&__pyx_v_fx), (&__pyx_v_fy), __pyx_v_w, __pyx_v_h);

        /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":74
 *                 _advance(vectors[y,x,0],vectors[y,x,1],
 *                         &x, &y, &fx, &fy, w, h)
 *                 k+=1             # <<<<<<<<<<<<<<
 *                 #print i, j, k, x, y
 ...
 */
        ...
        /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":76
 *                 k+=1
 *                 #print i, j, k, x, y
 *                 result[i,j] += kernel[k]*texture[x,y]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_27 = -1;
        if (__pyx_t_26 < 0) {
          __pyx_t_26 += __pyx_bshape_0_kernel;
          if (unlikely(__pyx_t_26 < 0)) __pyx_t_27 = 0;
        } else if (unlikely(__pyx_t_26 >= __pyx_bshape_0_kernel)) __pyx_t_27 = 0;
        ...
        __pyx_t_29 = -1;
        if (__pyx_t_27 < 0) {
          __pyx_t_27 += __pyx_bshape_0_texture;
          if (unlikely(__pyx_t_27 < 0)) __pyx_t_29 = 0;
        } else if (unlikely(__pyx_t_27 >= __pyx_bshape_0_texture)) __pyx_t_29 = 0;
        if (__pyx_t_28 < 0) {
          __pyx_t_28 += __pyx_bshape_1_texture;
          if (unlikely(__pyx_t_28 < 0)) __pyx_t_29 = 1;
        } else if (unlikely(__pyx_t_28 >= __pyx_bshape_1_texture)) __pyx_t_29 = 1;
        ...
        __pyx_t_31 = -1;
        if (__pyx_t_29 < 0) {
          __pyx_t_29 += __pyx_bshape_0_result;
          if (unlikely(__pyx_t_29 < 0)) __pyx_t_31 = 0;
        } else if (unlikely(__pyx_t_29 >= __pyx_bshape_0_result)) __pyx_t_31 = 0;
        if (__pyx_t_30 < 0) {
          __pyx_t_30 += __pyx_bshape_1_result;
          if (unlikely(__pyx_t_30 < 0)) __pyx_t_31 = 1;
        } else if (unlikely(__pyx_t_30 >= __pyx_bshape_1_result)) __pyx_t_31 = 1;
        if (unlikely(__pyx_t_31 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_31);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        *__Pyx_BufPtrStrided2d(float *, __pyx_bstruct_result.buf, __pyx_t_29, __pyx_bstride_0_result, __pyx_t_30, __pyx_bstride_1_result) += ((*__Pyx_BufPtrStrided1d(float *, __pyx_bstruct_kernel.buf, __pyx_t_26, __pyx_bstride_0_kernel)) * (*__Pyx_BufPtrStrided2d(float *, __pyx_bstruct_texture.buf, __pyx_t_27, __pyx_bstride_0_texture, __pyx_t_28, __pyx_bstride_1_texture)));
      }

      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":78
 *                 result[i,j] += kernel[k]*texture[x,y]
 * 
 *             x = j             # <<<<<<<<<<<<<<
 *             y = i
 ...
 */
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":79
 * 
 *             x = j
 *             y = i             # <<<<<<<<<<<<<<
 *             fx = 0.5
 ...
 */
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":80
 *             x = j
 *             y = i
 *             fx = 0.5             # <<<<<<<<<<<<<<
 *             fy = 0.5
 ...
 */
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":81
 *             y = i
 *             fx = 0.5
 *             fy = 0.5             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":83
 *             fy = 0.5
 * 
 *             while k>0:             # <<<<<<<<<<<<<<
 *                 _advance(-vectors[y,x,0],-vectors[y,x,1],
 ...
 */
      while (1) {
        ...
        /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":84
 * 
 *             while k>0:
 *                 _advance(-vectors[y,x,0],-vectors[y,x,1],             # <<<<<<<<<<<<<<
 *                         &x, &y, &fx, &fy, w, h)
 ...
 */
        ...
        __pyx_t_34 = -1;
        if (__pyx_t_31 < 0) {
          __pyx_t_31 += __pyx_bshape_0_vectors;
          if (unlikely(__pyx_t_31 < 0)) __pyx_t_34 = 0;
        } else if (unlikely(__pyx_t_31 >= __pyx_bshape_0_vectors)) __pyx_t_34 = 0;
        if (__pyx_t_32 < 0) {
          __pyx_t_32 += __pyx_bshape_1_vectors;
          if (unlikely(__pyx_t_32 < 0)) __pyx_t_34 = 1;
        } else if (unlikely(__pyx_t_32 >= __pyx_bshape_1_vectors)) __pyx_t_34 = 1;
        if (__pyx_t_33 < 0) {
          __pyx_t_33 += __pyx_bshape_2_vectors;
          if (unlikely(__pyx_t_33 < 0)) __pyx_t_34 = 2;
        } else if (unlikely(__pyx_t_33 >= __pyx_bshape_2_vectors)) __pyx_t_34 = 2;
        ...
        __pyx_t_37 = -1;
        if (__pyx_t_34 < 0) {
          __pyx_t_34 += __pyx_bshape_0_vectors;
          if (unlikely(__pyx_t_34 < 0)) __pyx_t_37 = 0;
        } else if (unlikely(__pyx_t_34 >= __pyx_bshape_0_vectors)) __pyx_t_37 = 0;
        if (__pyx_t_35 < 0) {
          __pyx_t_35 += __pyx_bshape_1_vectors;
          if (unlikely(__pyx_t_35 < 0)) __pyx_t_37 = 1;
        } else if (unlikely(__pyx_t_35 >= __pyx_bshape_1_vectors)) __pyx_t_37 = 1;
        if (__pyx_t_36 < 0) {
          __pyx_t_36 += __pyx_bshape_2_vectors;
          if (unlikely(__pyx_t_36 < 0)) __pyx_t_37 = 2;
        } else if (unlikely(__pyx_t_36 >= __pyx_bshape_2_vectors)) __pyx_t_37 = 2;
        if (unlikely(__pyx_t_37 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_37);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 84; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }

        /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":85
 *             while k>0:
 *                 _advance(-vectors[y,x,0],-vectors[y,x,1],
 *                         &x, &y, &fx, &fy, w, h)             # <<<<<<<<<<<<<<
 *                 k-=1
 *                 #print i, j, k, x, y
 */
        __pyx_f_12lic_internal__advance((-(*__Pyx_BufPtrStrided3d(float *, __pyx_bstruct_vectors.buf, __pyx_t_31, __pyx_bstride_0_vectors, __pyx_t_32, __pyx_bstride_1_vectors, __pyx_t_33, __pyx_bstride_2_vectors))), (-(*__Pyx_BufPtrStrided3d(float *, __pyx_bstruct_vectors.buf, __pyx_t_34, __pyx_bstride_0_vectors, __pyx_t_35, __pyx_bstride_1_vectors, __pyx_t_36, __pyx_bstride_2_vectors))), (&__pyx_v_x), (&__pyx_v_y), (&__pyx_v_fx), (&__pyx_v_fy), __pyx_v_w, __pyx_v_h);

        /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":86
 *                 _advance(-vectors[y,x,0],-vectors[y,x,1],
 *                         &x, &y, &fx, &fy, w, h)
 *                 k-=1             # <<<<<<<<<<<<<<
 *                 #print i, j, k, x, y
 ...
 */
        ...
        /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":88
 *                 k-=1
 *                 #print i, j, k, x, y
 *                 result[i,j] += kernel[k]*texture[x,y]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_38 = -1;
        if (__pyx_t_37 < 0) {
          __pyx_t_37 += __pyx_bshape_0_kernel;
          if (unlikely(__pyx_t_37 < 0)) __pyx_t_38 = 0;
        } else if (unlikely(__pyx_t_37 >= __pyx_bshape_0_kernel)) __pyx_t_38 = 0;
        ...
        __pyx_t_40 = -1;
        if (__pyx_t_38 < 0) {
          __pyx_t_38 += __pyx_bshape_0_texture;
          if (unlikely(__pyx_t_38 < 0)) __pyx_t_40 = 0;
        } else if (unlikely(__pyx_t_38 >= __pyx_bshape_0_texture)) __pyx_t_40 = 0;
        if (__pyx_t_39 < 0) {
          __pyx_t_39 += __pyx_bshape_1_texture;
          if (unlikely(__pyx_t_39 < 0)) __pyx_t_40 = 1;
        } else if (unlikely(__pyx_t_39 >= __pyx_bshape_1_texture)) __pyx_t_40 = 1;
        ...
        __pyx_t_42 = -1;
        if (__pyx_t_40 < 0) {
          __pyx_t_40 += __pyx_bshape_0_result;
          if (unlikely(__pyx_t_40 < 0)) __pyx_t_42 = 0;
        } else if (unlikely(__pyx_t_40 >= __pyx_bshape_0_result)) __pyx_t_42 = 0;
        if (__pyx_t_41 < 0) {
          __pyx_t_41 += __pyx_bshape_1_result;
          if (unlikely(__pyx_t_41 < 0)) __pyx_t_42 = 1;
        } else if (unlikely(__pyx_t_41 >= __pyx_bshape_1_result)) __pyx_t_42 = 1;
        if (unlikely(__pyx_t_42 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_42);
          {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        }
        *__Pyx_BufPtrStrided2d(float *, __pyx_bstruct_result.buf, __pyx_t_40, __pyx_bstride_0_result, __pyx_t_41, __pyx_bstride_1_result) += ((*__Pyx_BufPtrStrided1d(float *, __pyx_bstruct_kernel.buf, __pyx_t_37, __pyx_bstride_0_kernel)) * (*__Pyx_BufPtrStrided2d(float *, __pyx_bstruct_texture.buf, __pyx_t_38, __pyx_bstride_0_texture, __pyx_t_39, __pyx_bstride_1_texture)));
      }
    }
  }

  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":90
 *                 result[i,j] += kernel[k]*texture[x,y]
 * 
 *     return result             # <<<<<<<<<<<<<<
 * 
 */
  ...
  __pyx_L2:;
  __Pyx_DECREF((PyObject *)__pyx_v_result);
  __Pyx_DECREF((PyObject *)__pyx_v_vectors);
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("line_integral_convolution"), (PyCFunction)__pyx_pf_12lic_internal_line_integral_convolution, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_lic_internal(void)", __LINE__, __FILE__);
  #endif
  ...
  /* "/home/filipe/SciPy-Cookbook/LineIntegralConvolution/lic_internal.pyx":2
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * 
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init lic_internal");
