...
# created:  22-Jun-2011
# modified: Wed 22 Jun 2011 02:21:47 PM EDT
#
# obs: for compatibility only, most of these are or will be re-written in a more
# pythonic way.
#
...
def julian(y, m=0, d=0, h=0, mi=0, s=0):
    ...
    DESCRIPTION:  Converts Gregorian dates to decimal Julian days using the
                  ...
                  2440000 begins at 0000 hours, May 23, 1968. The decimal Julian
                  day, with Matlab's double precision, yeilds an accuracy of
